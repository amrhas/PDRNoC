 ...
 * fixed reconfig
 */
Flit *create_head_flit_fixed_reconfig_ack(int _src_x, int _src_y, int _dst_x, int _dst_y, int _time){
	Flit *flit_tmp = new Flit();
