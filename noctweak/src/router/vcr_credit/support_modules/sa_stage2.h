...
//	sc_out <int> sa_grant_stage2;		// =indexi
 ...
 */
template <int N_VCs>
void SAStage2<N_VCs>::sa_stage2_process(){
	int in_port_check = -1;
	int in_vc_check = -1;
...
//					sa_grant_stage2.write(indexi);	// choose input vc[pi][vi] for this output port
